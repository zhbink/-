...
from keras.layers import Input, LSTM, Dense, merge, Flatten, Embedding, Dropout,Bidirectional,GRU
...
def create_model():
    ...
    model.add(GRU(256,return_sequences=True,W_regularizer=l2(0.001)))
...
def train(i):
    ...
    bst_model_path = 'weights_gru_char'+str(i)
    ...
    model.load_weights('weights_gru_char'+str(i))
    model.save('./model/model_gru_attention_char_fanyi_'+str(i)+'.h5')
